...
;
; Macro Call - fftr2fn  data,data1,coef,odata,ptr1,ptr2
;
...
fftr2fn   macro     points,data,data1,coef,odata,ptr1,ptr2
fftr2fn   ident     1,0
...
_intdata  equ  0         					;address of internal data workspace
     move 	x:data1,r2        				;initialize input pointers
     move	r2,r0
...
; Program starts here.
     ...
     move 	#1023,a1                        			;store pointer to data block 1
     move 	#2047,m7                     			;set r7 for modulo addressing
     move 	a,x:ptr1
     move 	#2047,a1
     nop                       			;store pointer to data block 2
     move 	a,x:ptr2
...
;
;    call fft macro
     fftr2fn points,data,data1,coef,outdata,ptr1,ptr2
     nop
     nop
     end    
