...
; DSP56300's 56 bit arithmetic, 24 bit data storage and
...
reset   equ     0               
start   equ     $000100              
points  equ     64              					;64 point complex FFT
data    equ     $000400  						;External data starts at address $000400
outdata	equ	$001000
coef    equ     $000800  						;Coefficient table starts at address $000800
window  equ     $000C00
